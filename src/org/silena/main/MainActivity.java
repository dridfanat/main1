...
import org.silena.sipua.ui.RegisterService;
import org.silena.sipua.ui.Settings;
                            ...
                            case MainConstant.METHOD_REGISTRATION:
                                 int result =  intent.getIntExtra(MainConstant.PARAM_RESULT,0);
                                  ...
                                  switch(result){
                                     ...
                                     settings(); 
                                     Receiver.pos(true);
			             Receiver.engine(getUIContext()).halt();
			             Receiver.mSipdroidEngine = null;
			             Receiver.reRegister(0);

                                     Receiver.engine(getUIContext()).registerMore();
                                     Getbalance();
                                     break;    
	...
	public boolean onOptionsItemSelected(MenuItem item) {
		...
		case EXIT_MENU_ITEM: 
			...
			break;
                        ...
                        try {
                            intent = new Intent(this, org.silena.sipua.ui.Settings.class);
                            startActivity(intent);
...
//   Log.d(MainConstant.LOG_TAG, "Settings.PREF_EARGAIN" +  Float.toString( PreferenceManager.getDefaultSharedPreferences(getUIContext()).getFloat(Settings.PREF_EARGAIN, Settings.DEFAULT_EARGAIN)));
            
//   Log.d(MainConstant.LOG_TAG, "Settings.PREF_MICGAIN" +  Float.toString( PreferenceManager.getDefaultSharedPreferences(getUIContext()).getFloat(Settings.PREF_MICGAIN , Settings.DEFAULT_MICGAIN)));
               
 //  Log.d(MainConstant.LOG_TAG, "Settings.PREF_HEARGAIN" +  Float.toString( PreferenceManager.getDefaultSharedPreferences(getUIContext()).getFloat(Settings.PREF_HEARGAIN, Settings.DEFAULT_HEARGAIN)));
            
 //  Log.d(MainConstant.LOG_TAG, "Settings.PREF_HMICGAIN" +  Float.toString( PreferenceManager.getDefaultSharedPreferences(getUIContext()).getFloat(Settings.PREF_HMICGAIN, Settings.DEFAULT_HMICGAIN))); 
