...
public class VideoCamera extends CallScreen implements 
    ...
    public void onStart() {
        ...
        videoQualityHigh = PreferenceManager.getDefaultSharedPreferences(mContext).getString(org.silena.sipua.ui.Settings.PREF_VQUALITY, org.silena.sipua.ui.Settings.DEFAULT_VQUALITY).equals("high");
    ...
    public void onResume() {
        ...
        if (!justplay) {
	        ...
	        startVideoRecording();
        } else if (Receiver.engine(mContext).getRemoteVideo() != 0 && PreferenceManager.getDefaultSharedPreferences(this).getString(org.silena.sipua.ui.Settings.PREF_SERVER, org.silena.sipua.ui.Settings.DEFAULT_SERVER).equals(org.silena.sipua.ui.Settings.DEFAULT_SERVER)) {
