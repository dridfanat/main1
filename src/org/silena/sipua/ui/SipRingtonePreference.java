...
{   
    ...
    protected void onSaveRingtone(Uri ringtoneUri) 
    {
		...
		edit.putString(org.silena.sipua.ui.Settings.PREF_SIPRINGTONE, ringtoneUri != null ? ringtoneUri.toString() : org.silena.sipua.ui.Settings.DEFAULT_SIPRINGTONE);		
		edit.commit();        
    }
    ...
    {
        String uriString = PreferenceManager.getDefaultSharedPreferences(mContext).getString(org.silena.sipua.ui.Settings.PREF_SIPRINGTONE,
