...
import org.silena.sipua.phone.CallCard;
import org.silena.sipua.phone.Phone;
import org.silena.sipua.phone.SlidingCardManager;
...
public class InCallScreen extends CallScreen implements View.OnClickListener, SensorEventListener {
	...
	public void onResume() {
		...
		case UserAgent.UA_STATE_INCOMING_CALL:
			if (Receiver.pstn_state == null || Receiver.pstn_state.equals("IDLE"))
				if (PreferenceManager.getDefaultSharedPreferences(mContext).getBoolean(org.silena.sipua.ui.Settings.PREF_AUTO_ON, org.silena.sipua.ui.Settings.DEFAULT_AUTO_ON) &&
						!mKeyguardManager.inKeyguardRestrictedInputMode())
					mHandler.sendEmptyMessageDelayed(MSG_ANSWER, 1000);
				else if ((PreferenceManager.getDefaultSharedPreferences(mContext).getBoolean(org.silena.sipua.ui.Settings.PREF_AUTO_ONDEMAND, org.silena.sipua.ui.Settings.DEFAULT_AUTO_ONDEMAND) &&
						PreferenceManager.getDefaultSharedPreferences(mContext).getBoolean(org.silena.sipua.ui.Settings.PREF_AUTO_DEMAND, org.silena.sipua.ui.Settings.DEFAULT_AUTO_DEMAND)) ||
						(PreferenceManager.getDefaultSharedPreferences(mContext).getBoolean(org.silena.sipua.ui.Settings.PREF_AUTO_HEADSET, org.silena.sipua.ui.Settings.DEFAULT_AUTO_HEADSET) &&
								Receiver.headset > 0))
	        ...
	        (t = new Thread() {
				public void run() {
					...
					if (Settings.System.getInt(getContentResolver(),
						...
						tg = new ToneGenerator(AudioManager.STREAM_VOICE_CALL, (int)(ToneGenerator.MAX_VOLUME*2*org.silena.sipua.ui.Settings.getEarGain()));
					for (;;) {
						if (!running) {
							t = null;
							break;
	...
	public void onSensorChanged(SensorEvent event) {
		boolean keepon = PreferenceManager.getDefaultSharedPreferences(mContext).getBoolean(org.silena.sipua.ui.Settings.PREF_KEEPON, org.silena.sipua.ui.Settings.DEFAULT_KEEPON);
		if (first) {
			first = false;
			return;
		}
