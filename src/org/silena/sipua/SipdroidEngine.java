 ...
 */
package org.silena.sipua;
import org.silena.R;
import java.io.IOException;
import java.net.UnknownHostException;

import org.silena.net.KeepAliveSip;
import org.silena.sipua.ui.ChangeAccount;
import org.silena.sipua.ui.LoopAlarm;
...
//    }
    ...
    public boolean StartEngine() {
        ...
        if (wl == null) {
            if (!PreferenceManager.getDefaultSharedPreferences(getUIContext()).contains(org.silena.sipua.ui.Settings.PREF_KEEPON)) {
                Editor edit = PreferenceManager.getDefaultSharedPreferences(getUIContext()).edit();

                edit.putBoolean(org.silena.sipua.ui.Settings.PREF_KEEPON, true);
                edit.commit();
            }
        ...
        for (UserAgentProfile user_profile : user_profiles) {
            if (wl[i] == null) {
                ...
                if (!PreferenceManager.getDefaultSharedPreferences(getUIContext()).getBoolean(org.silena.sipua.ui.Settings.PREF_KEEPON, org.silena.sipua.ui.Settings.DEFAULT_KEEPON)) {
