...
{  
   ...
   {  log=logger;
      ...
      try
      {
    	 ...
    	 if (PreferenceManager.getDefaultSharedPreferences(Receiver.mContext).getBoolean(org.silena.sipua.ui.Settings.PREF_CALLRECORD,
					org.silena.sipua.ui.Settings.DEFAULT_CALLRECORD))
