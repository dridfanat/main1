...
package org.silena.media;
import org.silena.R;
import java.io.IOException;
import java.net.SocketException;

import org.silena.net.RtpPacket;
import org.silena.net.RtpSocket;
import org.silena.net.SipdroidSocket;
 
import org.silena.sipua.UserAgent;
import org.silena.sipua.ui.InCallScreen;
import org.silena.sipua.ui.Receiver;
import org.silena.sipua.ui.Sipdroid;
import org.silena.codecs.Codecs;
...
public class RtpStreamReceiver extends Thread {
	...
	public static synchronized void ringback(boolean ringback) {
		if (ringback && ringbackPlayer == null) {
			...
			setMode(speakermode);
			enableBluetooth(PreferenceManager.getDefaultSharedPreferences(Receiver.mContext).getBoolean(org.silena.sipua.ui.Settings.PREF_BLUETOOTH,
					org.silena.sipua.ui.Settings.DEFAULT_BLUETOOTH));
			...
			ringbackPlayer = new ToneGenerator(stream(),(int)(ToneGenerator.MAX_VOLUME*2*org.silena.sipua.ui.Settings.getEarGain()));
	...
	void restoreVolume() {
		...
		case AudioManager.MODE_IN_CALL:
				...
				if (oldring > 0) setStreamVolume(AudioManager.STREAM_RING,(int)(
						...
						org.silena.sipua.ui.Settings.getEarGain()*3), 0);
				track.setStereoVolume(AudioTrack.getMaxVolume()*
						(ogain = org.silena.sipua.ui.Settings.getEarGain()*2)
						,AudioTrack.getMaxVolume()*
						org.silena.sipua.ui.Settings.getEarGain()*2);
	...
	void saveSettings() {
		if (!PreferenceManager.getDefaultSharedPreferences(Receiver.mContext).getBoolean(org.silena.sipua.ui.Settings.PREF_OLDVALID, org.silena.sipua.ui.Settings.DEFAULT_OLDVALID)) {
			...
			if (!PreferenceManager.getDefaultSharedPreferences(Receiver.mContext).contains(org.silena.sipua.ui.Settings.PREF_OLDVIBRATE2))
			...
			Editor edit = PreferenceManager.getDefaultSharedPreferences(Receiver.mContext).edit();
			edit.putInt(org.silena.sipua.ui.Settings.PREF_OLDVIBRATE, oldvibrate);
			edit.putInt(org.silena.sipua.ui.Settings.PREF_OLDVIBRATE2, oldvibrate2);
			edit.putInt(org.silena.sipua.ui.Settings.PREF_OLDPOLICY, oldpolicy);
			edit.putInt(org.silena.sipua.ui.Settings.PREF_OLDRING, am.getStreamVolume(AudioManager.STREAM_RING));
			edit.putBoolean(org.silena.sipua.ui.Settings.PREF_OLDVALID, true);
			edit.commit();
		}
	}
	...
	public static void setMode(int mode) {
		Editor edit = PreferenceManager.getDefaultSharedPreferences(Receiver.mContext).edit();
		edit.putBoolean(org.silena.sipua.ui.Settings.PREF_SETMODE, true);
		edit.commit();
		AudioManager am = (AudioManager) Receiver.mContext.getSystemService(Context.AUDIO_SERVICE);
		if (Integer.parseInt(Build.VERSION.SDK) >= 5) {
	...
	public static void restoreMode() {
		if (PreferenceManager.getDefaultSharedPreferences(Receiver.mContext).getBoolean(org.silena.sipua.ui.Settings.PREF_SETMODE, org.silena.sipua.ui.Settings.DEFAULT_SETMODE)) {
			Editor edit = PreferenceManager.getDefaultSharedPreferences(Receiver.mContext).edit();
			edit.putBoolean(org.silena.sipua.ui.Settings.PREF_SETMODE, false);
			edit.commit();
	...
	public static void restoreSettings() {
		if (PreferenceManager.getDefaultSharedPreferences(Receiver.mContext).getBoolean(org.silena.sipua.ui.Settings.PREF_OLDVALID, org.silena.sipua.ui.Settings.DEFAULT_OLDVALID)) {
			...
			int oldvibrate = PreferenceManager.getDefaultSharedPreferences(Receiver.mContext).getInt(org.silena.sipua.ui.Settings.PREF_OLDVIBRATE, org.silena.sipua.ui.Settings.DEFAULT_OLDVIBRATE);
			int oldvibrate2 = PreferenceManager.getDefaultSharedPreferences(Receiver.mContext).getInt(org.silena.sipua.ui.Settings.PREF_OLDVIBRATE2, org.silena.sipua.ui.Settings.DEFAULT_OLDVIBRATE2);
			int oldpolicy = PreferenceManager.getDefaultSharedPreferences(Receiver.mContext).getInt(org.silena.sipua.ui.Settings.PREF_OLDPOLICY, org.silena.sipua.ui.Settings.DEFAULT_OLDPOLICY);
			...
			Editor edit = PreferenceManager.getDefaultSharedPreferences(Receiver.mContext).edit();
			edit.putBoolean(org.silena.sipua.ui.Settings.PREF_OLDVALID, false);
			edit.commit();
	...
	public void run() {
		boolean nodata = PreferenceManager.getDefaultSharedPreferences(Receiver.mContext).getBoolean(org.silena.sipua.ui.Settings.PREF_NODATA, org.silena.sipua.ui.Settings.DEFAULT_NODATA);
		keepon = PreferenceManager.getDefaultSharedPreferences(Receiver.mContext).getBoolean(org.silena.sipua.ui.Settings.PREF_KEEPON, org.silena.sipua.ui.Settings.DEFAULT_KEEPON);
		...
		ToneGenerator tg = new ToneGenerator(AudioManager.STREAM_VOICE_CALL,(int)(ToneGenerator.MAX_VOLUME*2*org.silena.sipua.ui.Settings.getEarGain()));
		track.play();
		System.gc();
		empty();
		lockFirst = true;
